...
interface InstanceDAO {
    ...
    /**
     * Get number of posts captured for every instance between two dates.
     ...
     * @param str $network The network to use in the call
    ...
    /**
     * Get number of posts saved with a hashtag for every instance between two dates.
     * @param start_date $date start date of posts returned. Default Today at 00:00:00.
     * @param end_date $date end date of posts returned. Default Today at 23:59:59.
     * @param str $network The network to use in the call.
